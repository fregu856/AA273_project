...
class MoveToPosition2DActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = MoveToPosition2DFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new MoveToPosition2DActionFeedback();
    ...
    tmp = MoveToPosition2DFeedback.deserialize(buffer);
